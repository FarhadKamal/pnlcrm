        ...
        <div class="col-md-4">
            <form action="{{ route('locations') }}" method="POST">
                ...
                <div>
                    ...
                    <input type="text" class="form-control fs-08rem" name="locName" id="locName" required>
                </div>
                <div>
                    ...
                    @foreach ($locations as $item)
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-xs btn-info p-2"
                                    onclick="editLocation({{ $item->id }})"><i
...
<!-- Modal -->
<div class="modal top fade" id="locEditModal" tabindex="-1" aria-labelledby="locEditModalLabel" aria-hidden="true"
        ...
        <div class="modal-content">
            ...
            <form action="{{route('updateLocation')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <label class="form-label">Location Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control fs-08rem" name="locEditName" id="locEditName"
                            required>
                    </div>
                    <div>
                        <label class="form-label">Status <span class="text-danger">*</span></label>
                        <select name="locEditStatus" id="locEditStatus" class="form-control fs-08rem">
    ...
    function editLocation(itemId) {
        ...
        $.ajax({
            ...
            success: function(data) {
                document.getElementById("locEditName").value = data.loc_name;
                document.getElementById("itemId").value = data.id;
                if (data.is_active == 1) {
                    $("#locEditStatus").val(1).selected;
                } else {
                    $("#locEditStatus").val(0).selected;
                }
